...
For a Project in which the Work is a Material Component:
  ...
  Tier 2 — above EUR 1,000,000 and up to EUR 5,000,000 (rolling twelve (12) months):
           Licensee must notify Licensor at <your-email> and negotiate a paid
           Distribution Agreement. If no agreement is signed within sixty (60) days
           from Licensor’s receipt of notice, Licensee may continue under a default
           commercial add-on royalty equal to ten percent (10%) of Qualified Revenue
           for that period, payable quarterly, capped at EUR 200,000 per calendar
           year, with reporting under §4(e).
  Tier 3 — above EUR 5,000,000 (rolling twelve (12) months), or cumulative funding/
